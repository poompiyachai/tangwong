...
*/
        ...
        btn_create_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("roomid",roomid);
            mDatabase.child("room").child(roomid).child("menu").setValue("https://firebasestorage.googleapis.com/v0/b/tangwong-862c9.appspot.com/o/Photos%2Fwww.maxpixel.net-Taxes-Control-Smart-Home-Icon-Technology-Home-3317459.png?alt=media&token=329741c8-000f-4c85-bd9f-ca5b4e99442d");
